package io.github.opcoral.beanlog.entity.config;
...
public class BeanLogConfig {
     ...
     * 日志生效的变更类型<br>
     * 未指定的变更类型不会记录日志<br>
     * 全局默认：new BeanLogChangeType[]{BeanLogChangeType.UPDATE, BeanLogChangeType.INSERT, BeanLogChangeType.DELETE}
     */
    private BeanLogChangeType[] effectiveType;
     ...
     * 全局默认：包含解析一些常见类型的Map
     */
    private Map<Class<?>, BeanLogStringConverter> converterMap;
     ...
     * 全局默认：new ArrayList<>()
     */
    private List<BeanLogParamEditor> paramEditors;

    /**
     * 比较器<br>
     * 全局默认：调用equal的方法
     */
    private BeanLogComparable comparable;
